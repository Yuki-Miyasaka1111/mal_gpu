...
def process_single_json_file(file_path ):
    """
    指定されたJSONファイルに対して、'Description' フィールド内の
...
# 入力フォルダのパスを設定
file_path  = '/workspaces/mal_gpu/data/interim/extract_all_data/njrat/3a4864163edd1ccae20fdfbcfbabbdd49c70f923f29c0f4a8c1687fa5c734eee.json'
